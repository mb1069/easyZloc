...
echo "Training model...";
cd $OUTDIR && echo $PWD &&
echo python3  ~/publication/train_model_debug_alt_model.py --dataset openframe -o out_roll_alignment --aug_ratio 2 --brightness $BRIGHTNESS --gauss $GAUSS;
...
python3 ~/publication/render_nup.py -l $OUTDIR/out_roll_alignment/out_nup/locs_3d.hdf5 -px $PX_SIZE -p $PICKED_LOCS_NUP -df -os 10 -k 0.5;
# cd $OUTDIR/out_roll_alignment && echo $PWD &&
